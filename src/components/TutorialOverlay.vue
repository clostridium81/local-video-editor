...
const STEPS_EASY: Step[] = [
  ...
  },
  {
    ...
    body:
      '↶↷ で元に戻す / やり直し。\n' +
      '「復元」「バックアップ」で作品の保存・読み込み、🎙 録画・録音、🎚 音声ミキサー、? ショートカット一覧、▼ 動画の書き出し。\n' +
...
const STEPS_NORMAL: Step[] = [
  ...
  },
  {
    ...
    body:
      ...
      '種類で絞り込み、検索もできます。素材と編集内容は自動保存されません。続きを編集するには ZIP バックアップを保存してください。',
    placement: 'right'
  },
  {
    target: '[data-tour="preview"]',
  ...
  },
  {
    ...
    title: '⑥ メニュー',
    body:
      '左から Undo/Redo、復元・バックアップ (手動保存/読み込み)、録画・ナレーション録音、オーディオミキサー、\n' +
      'キーボードショートカット、動画書き出し(MP4/WebM/GIF)。\n' +
